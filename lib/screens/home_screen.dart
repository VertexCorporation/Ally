...
class _HomeScreenState extends State<HomeScreen> with TickerProviderStateMixin {
          ...
          child: Column(
            ...
            children: [
              ...
              Container(
                ...
                child: const Icon(Icons.directions_walk_rounded, color: Color(0xFF4BAADF), size: 32),
              ),
              const SizedBox(height: 16),
              Text(
                AppLocalizations.of(context)!.enableStepTracking,
              ...
              Padding(
                ...
                child: Text(
                  AppLocalizations.of(context)!.stepPermissionMessage,
                          ...
                          if (status.isGranted) {
                            ...
                            if (mounted) {
                              ScaffoldMessenger.of(context).showSnackBar(
                                SnackBar(
                                  content: Text(AppLocalizations.of(context)!.stepTrackingEnabled),
  ...
  Widget _buildActivityTile({required String title, required String subtitle, required IconData icon, required Color color, required int delay}) {
            ...
            child: Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  const Spacer(),
                  Text(title, style: const TextStyle(fontSize: 16, fontWeight: FontWeight.bold, height: 1.2, color: Colors.white)),
                  if (subtitle.isNotEmpty) ...[
                    const SizedBox(height: 4),
                    Text(subtitle, style: const TextStyle(fontSize: 12, color: Colors.white70, height: 1.2)),
                  ],
                ],
              ),
            ),
  ...
  Widget _buildNutritionCard(String value, Color color, int delay) {
    return Consumer<HealthProvider>(
      builder: (context, healthProvider, child) {
        final calorieProgress = healthProvider.healthData.caloriesConsumed / healthProvider.healthData.caloriesGoal;
  ...
  Widget _buildOldMetricCard(String title, String value, IconData icon, Color color, double progress) {
    return Container(
      padding: const EdgeInsets.all(16),
      decoration: BoxDecoration(
        color: Theme.of(context).cardColor,
          ...
          Expanded(
            child: Column(
              ...
              children: [
                ...
                const SizedBox(height: 4),
                Text(value, style: const TextStyle(fontSize: 12, color: Color(0xFF888888))),
              ],
            ),
          ),
          SizedBox(
            ...
            child: TweenAnimationBuilder<double>(
              ...
              curve: Curves.easeOut,
              builder: (context, value, child) => CustomPaint(painter: CircleProgressPainter(progress: value, color: color)),
            ),
          ),
        ],
      ),
    ...
    if (isMenu) {
      return GestureDetector(
        ...
        child: AnimatedContainer(
          ...
          padding: const EdgeInsets.all(12),
          decoration: BoxDecoration(
            color: _isMenuExpanded ? Colors.grey.withOpacity(0.15) : Colors.transparent,
            borderRadius: BorderRadius.circular(20),
          ),
  ...
  Widget _buildSleepCard(String value, Color color, int delay, IconData icon) {
    return Consumer<HealthProvider>(
      builder: (context, healthProvider, child) {
        final sleepHours = healthProvider.healthData.sleepHours;
        final goalHours = 8.0;
        final progress = sleepHours / goalHours;
